...
public class BidSourceFunction extends RichParallelSourceFunction<Bid> implements CheckpointedFunction {
    ...
    public void initializeState(FunctionInitializationContext context) throws Exception {
        ...
        if (time == null) {
            ...
            System.out.println("BidSourceFunction:  Initialized time value state");
        } else {
            System.out.println("BidSourceFunction:  Value state recovered.. time="+time);
        }
        ...
        if (eventsCountSoFar == null) {
            eventsCountSoFar=0L;
            System.out.println("BidSourceFunction:  Initialized eventsCountSoFar value state");
        } else {
            System.out.println("BidSourceFunction:  Value state recovered.. eventsCountSoFar="+eventsCountSoFar);
        }
        stateBidSource.clear();
        stateBidSource.add(time);
//        updateRates();
        System.out.println("BidSourceFunction:  Updated rates, " + rates.toString());
    }
