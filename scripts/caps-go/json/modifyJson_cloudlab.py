...
query = {}
query["Q2_Sink"] = None
query["TumblingEventTimeWindows"] = 12
query["Q2_TransformPersons"] = None
query["Q2_SourcePersons"] = None
query["Q2_TransformAuctions"] = 9
query["Q2_SourceAuctions"] = None
oldTargetRate = 58000 * 6
newTargetRate = 50000 * 6
queries.append(query)
targetRateFactors.append(newTargetRate/oldTargetRate)
...
# This query shows high join cost after warmup
# need re-profile
query = {}
...
query["Q4_Sink"] = None
oldTargetRate = 47000 * 6
newTargetRate = 47000 * 6
queries.append(query)
targetRateFactors.append(newTargetRate/oldTargetRate)
...
query["Q5_Sink"] = None
oldTargetRate = 58000 * 2
newTargetRate = 58000 * 2
queries.append(query)
targetRateFactors.append(newTargetRate/oldTargetRate)
...
query["Q6_Sink"] = None
oldTargetRate = 36000 * 4
newTargetRate = 36000 * 4
queries.append(query)
targetRateFactors.append(newTargetRate/oldTargetRate)


input_file_path = "singlequery_cloudlab/Q1.json"
output_file_path = "singlequery_cloudlab/Q1_updated.json"
