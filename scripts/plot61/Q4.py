...
customFolder = "../q4/q4_custom"
evenFolder = "../q4/q4_even"
randomFolder = "../q4/q4_random"
...
with os.scandir(customFolder) as entries:
    ...
    for entry in entries:
        ...
        for node, attrs in jg.nodes(data=True):
            if 'Source' in attrs['pname'] and 'SourceAuctions' in attrs['pname']:
...
def format_func(value, tick_number):
    ...
    # return f'{(value / 1000000):.1f}m' if value >= 1000 else int(value)
...
ax[0].tick_params(axis='y', labelsize=5.4)
...
plt.savefig('./q4-join.png', dpi=300)
plt.close()